...
class App:
    def __init__(self, username='josep.martorell.33', password='F0renXis1234****', target_username='dataminer2060',
                 path='/home/jmartorell/Imágenes/instaPhotos'):  # Change this to your Instagram details and desired images path
        self.username = username
        self.password = password
        self.target_username = target_username
        self.path = path
        self.driver = webdriver.Firefox(executable_path='/usr/local/bin/geckodriver')  # Change this to your FirefoxDriver path.
        self.error = False
